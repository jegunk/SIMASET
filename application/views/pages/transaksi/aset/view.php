...
<h4><strong>Detail ASET</strong><a class="btn btn-default pull-right btn-sm" href="<?PHP echo base_url();?>index.php/transaksi/aset" title="Kembali">Kembali</a></h4>
<hr>
...
<p class="text-14">
	...
	<select name="sumber_dana" id="sumber_dana" required="required" class="form-control" <?PHP echo $disabled;?>>
...
<a class="btn btn-primary" title="Ubah" href="<?PHP echo base_url();?>index.php/transaksi/aset/edit/<?PHP echo $aset->kode_aset;?>">Ubah</a>
<a class="btn btn-danger" title="Hapus" href="<?PHP echo base_url();?>index.php/transaksi/aset/delete/<?PHP echo $aset->kode_aset;?>" onclick="return confirm('Anda yakin hapus data ini?');">Hapus</a>
<a class="btn btn-default" title="Cetak" href="<?PHP echo base_url();?>index.php/transaksi/aset/cetak/<?PHP echo $aset->kode_aset;?>" onclick="return confirm('Cetak data ini?');" target="_blank">Cetak Label</a>
<a class="btn btn-default" title="Cetak" href="<?PHP echo base_url();?>index.php/transaksi/aset/cetak_spek/<?PHP echo $aset->kode_aset;?>" onclick="return confirm('Cetak data ini?');" target="_blank">Cetak Spesifikasi Barang</a>
</td></tr>
