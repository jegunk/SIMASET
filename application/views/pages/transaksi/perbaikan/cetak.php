...
<br>
      ...
      <tr><td colspan="12"><p style="text-align: center;font-size: 20px;font-weight: 900">FORMULIR PERBAIKAN</p><p style="text-align: center;font-weight: 900"><?PHP echo $perbaikan->kode_perbaikan;?></p></td>
      </tr>
      
      <tr height="20"></tr>
    <?PHP $b= date_format(date_create($perbaikan->tgl_perbaikan),'d F Y');?> 
      <tr>
        <td>Nama </td>
    ...
    <tr>
      <td>Perihal :</td>
      <td colspan="4" width="100px"> <?PHP if($perbaikan->nama_jenis_barang == "Medis"){
        $z = "&#9632;";
      } else { 
        $z = "&#9633;";
      }?>
      ...
      <td colspan="3"> <?PHP if($perbaikan->nama_jenis_barang == "Umum"){
        $x = "&#9632;";
      } else { 
        $x = "&#9633;";
      }?>
      ...
      <td colspan="3"> <?PHP if($perbaikan->nama_jenis_barang == "TI"){
        $y = "&#9632;";
      } else { 
        $y = "&#9633;";
      }?>
    ...
    <table cellspacing="0" cellpadding="0" border="1 solid black" style="table-layout: fixed;">
      ...
      <th width="233px">Keterangan Perbaikan</th>

      <tr>
        <td style="height: 200px; vertical-align: top; text-align: center;padding-left:0.5rem;padding-top: 0.5rem">1</p></td>
        <td style="max-width:150px; vertical-align: top;"><p style="padding-left: 0.5rem;padding-top: 0.5rem"><?PHP echo $perbaikan->nama_barang?></p></td>
        <td style="max-width:150px; vertical-align: top;"><p style="padding-left: 0.5rem;padding-top: 0.5rem"><?PHP echo $perbaikan->merk_barang;?><br>
        <?PHP echo $perbaikan->tipe_barang;?><br><?PHP echo $perbaikan->warna_barang;?></p></td>
        <td style="max-width:150px; vertical-align: top;"><p style="padding-right: 0.5rem;padding-left: 0.5rem;padding-top: 0.5rem;text-align: justify;text-justify : inter-word"><?PHP echo $perbaikan->keterangan?></p></td>
      </tr>
      <tr>
        <td height="30px"></td>
        <td height="30px"></td>
