...
<h4><strong>Ubah Data Form Perbaikan Aset</strong><a class="btn btn-default pull-right btn-sm" href="<?PHP echo base_url();?>index.php/transaksi/Perbaikan" title="Kembali">Kembali</a></h4>
<hr>
<?php echo form_open_multipart('transaksi/perbaikan/edit_aksi')?>
...
<p class="text-14">
	...
	<td><button type="submit" class="btn btn-primary" title="Simpan" id="submit" name="submit">Simpan</button></td>
</tr>
<?php echo form_close();?>