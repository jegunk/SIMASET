...
<h4><strong>Detail User</strong><a class="btn btn-default pull-right btn-sm" href="<?PHP echo base_url();?>index.php/setup/user" title="Kembali">Kembali</a></h4>	
<hr>
<table>
	<th colspan="2"></th>
	<tr>
...
<td rowspan="2" style="width: 250px"><img src="<?PHP echo base_url()?>/assets/upload/img/user/<?php echo $data->gambar;?>" style="width : auto;
      height: auto;
      display: block;
      margin-left: auto;
...
<a class="btn btn-danger" title="Hapus" href="<?PHP echo base_url();?>index.php/setup/user/delete/<?PHP echo $data->id_user;?>" onclick="return confirm('Hapus data ini?');">Hapus</a>